        ...
        <div className="bg-[#081c30] bg-opacity-60 rounded-2xl p-6 md:p-10 w-full max-w-md shadow-2xl border border-[#081c30] border-opacity-5 z-10 backdrop-blur-sm">
          ...
          <form className="flex flex-col gap-5" onSubmit={handleLogin}>
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2 bg-white text-gray-800 border-none py-3.5 rounded-lg font-medium text-base cursor-pointer transition-all duration-300 shadow-md hover:-translate-y-1 hover:shadow-lg disabled:opacity-70 disabled:hover:translate-y-0"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
